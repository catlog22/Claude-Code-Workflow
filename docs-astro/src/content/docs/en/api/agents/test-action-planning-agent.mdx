...
description: "Specialized agent extending action-planning-agent for test planning documents. Generates test task JSONs (IMPL-001, IMPL-001.3, IMPL-001.5, IMPL-002) with pr..."
category: "api"
locale: "en"
order: 18
---
