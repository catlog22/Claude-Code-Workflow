...
description: "Pure execution agent for creating implementation plans based on provided requirements and control flags. This agent executes planning tasks without complex d..."
category: "api"
locale: "en"
order: 2
---
...
| **Color** | blue |
| **Tools** | `Glob`, `Grep`, `Read`, `mcp__exa__get_code_context_exa`, `mcp__exa__web_search_exa` |

## Key Capabilities

- Session Paths
- Metadata
- pre_analysis configuration
- Control flags
- Task requirements
