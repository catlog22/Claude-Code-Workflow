...
description: "Pure code execution agent for implementing programming tasks and writing corresponding tests. Focuses on writing, implementing, and developing code with prov..."
category: "api"
locale: "en"
order: 9
---
...
| **Name** | `code-developer` |
| **Color** | blue |
| **Tools** | `Glob`, `Grep`, `Read`, `mcp__exa__get_code_context_exa`, `mcp__exa__web_search_exa`, `mcp__xxx__yyy` |
